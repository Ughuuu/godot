...
// network activity timeout which is set with SetHTTPRequestNetworkActivityTimeout which can bump every time we get more data.
...
// Gets the major and minor device binding revisions for Steam Input API configurations. Minor revisions are for small changes
...
// These functions do not have any official notes or comments.  All descriptions are assumed.
//
...
// Did the currently music entry just change?
